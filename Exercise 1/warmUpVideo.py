...
#<!-- File       : warmUpVideo.py                                          -->
#<!-- Description: Example of code for opening videos using OpenCV          -->
...
#<!-- Date       : 23/01/2018                                               -->
#<!-- Change     : 23/01/2018 - Creation of this script                     -->
#<!-- Review     : 23/01/2018 - Finalized                                   -->
#<!--------------------------------------------------------------------------->

__version__ = "$Revision: 2018012301 $"
